...
public class UserController {
	...
	@PatchMapping("/assignRole/{id}/{newRole}")
	public ResponseEntity<?> assignRoleToUser(@PathVariable Long id, @PathVariable String newRole){
		User user =userService.assignRole(id,newRole);
		return new ResponseEntity<User>(user, HttpStatus.OK);
	}
